...
# model.load_state_dict(torch.load('./model/model-APD-pytorch-res50-92accuracy.pt', map_location=torch.device('cpu')))
model.load_state_dict(torch.load('./model/model-APD-pytorch-res50-92accuracy.pt', map_location='cpu'))
